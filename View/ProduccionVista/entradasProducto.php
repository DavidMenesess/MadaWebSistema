...
<head>
    ...
    <title>Entradas de productos || Mada</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4 text-center">Entradas de productos<?php //echo //$producto['NombreProducto']
                                                                        ?></h1>
                    <br>
                    ...
                    <form action="../../Controller/ProduccionControlador/controladorProductos.php" method="POST" accept-charset="utf-8" onsubmit="return validarBusquedaEntrada()" autocomplete="off">
                        <div class="">
                            <!--Aqui va el container para el formulario y el producto-->
